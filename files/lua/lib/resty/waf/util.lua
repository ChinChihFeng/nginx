...
_M.parse_collection = {
	...
	regex = function(waf, collection, value)
		if waf._debug == true then ngx.log(waf._debug_log_level, '[', waf.transaction_id, '] ', "Parse collection is geting for the regex: " .. value) end
		local v
		local n = 0
		local _collection = {}
	...
	ignore = function(waf, collection, value)
		if waf._debug == true then ngx.log(waf._debug_log_level, '[', waf.transaction_id, '] ', "Parse collection is ignoring a value: " .. value) end
		local _collection = {}
